...
namespace Plan_A_Plant.Migrations
{
    ...
    [Migration("20240626032122_AddtransactioinmodeTowallettransaction")]
    partial class AddtransactioinmodeTowallettransaction
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Plan_A_Plant.Models.MultipleAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Plan_A_Plant.Models.WalletTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Plan_A_Plant.Models.WalletTransaction", b =>
                {
                    b.HasOne("Plan_A_Plant.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
